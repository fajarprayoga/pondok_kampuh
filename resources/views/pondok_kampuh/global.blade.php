		...
		<div class="header_content d-flex flex-row align-items-center justify-content-start">
			...
			<nav class="main_nav">
				<ul class="d-flex flex-row align-items-start justify-content-start">
					...
					<li class="{{ Request::routeIs('historyOrder') ? 'active' : '' }}"><a href="{{route('historyOrder')}}" >History Order <span style="background-color: aquamarine; padding: 5px; border-radius: 50%; height: 10px; width: 10px;;">{{$countOrderNew}}</span></a></li>
